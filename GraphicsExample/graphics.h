...
enum buttonColors
{
    green = COLOR(91,	189	,43),
    red = COLOR(178,	0,	31),
    red3 = COLOR(255, 48 ,48),
    red2 = COLOR(244 ,164, 96),
    blue = COLOR(110,	195	,201),
    grey = COLOR(236,	236	,236),
    yellow = COLOR(252	,245	,76),
    blue_A = COLOR(0	,178	,191),
    blue_B = COLOR(100 ,149 ,237),
    blue_d = COLOR(151, 255, 255),
    Crimson = COLOR(220 ,20, 60),
    Plum1 = COLOR(240, 255, 255),
    Seashell1 = COLOR(255, 245 ,238),
    xinh = COLOR(85, 172, 238),
    xinh2 = COLOR(23, 105, 255),
    WhatsApp = COLOR(67, 216, 84),
    Snapchat = COLOR(255, 250, 55),
    Flattr = COLOR(246, 124, 26 / 51, 141, 17)
};
